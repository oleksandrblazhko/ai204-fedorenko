...
CREATE OR REPLACE TYPE Admin UNDER User (
...
/* Створення об'єктного типу (клас) Cleanser */
CREATE OR REPLACE TYPE Cleanser AS OBJECT (
...
/* Створення об'єктного типу (клас) since_work */
